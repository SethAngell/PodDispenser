"""
Django settings for PodDispenser project.
...
ROOT_URLCONF = "PodDispenser.urls"
...
WSGI_APPLICATION = "PodDispenser.wsgi.application"
...
if bool(int(os.environ.get("USE_S3", 0))):
    ...
    AWS_S3_ENDPOINT_URL = "https://cdn.profoundbitching.com/"
    AWS_DEFAULT_ACL = "public-read"

    # Static Config
    STATIC_LOCATION = "static"
    STATICFILES_STORAGE = "PodDispenser.storage_backends.StaticStorage"
    STATIC_URL = f"{AWS_S3_ENDPOINT_URL}{STATIC_LOCATION}/"

    # Media Config
    PUBLIC_MEDIA_LOCATION = "media"
    MEDIA_URL = f"{AWS_S3_ENDPOINT_URL}{PUBLIC_MEDIA_LOCATION}/"
    DEFAULT_FILE_STORAGE = "PodDispenser.storage_backends.PublicMediaStorage"
